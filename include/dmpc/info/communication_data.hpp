...
#ifndef COMMUNICATION_DATA_HPP
#define COMMUNICATION_DATA_HPP
...
public:
    CommunicationData(asio::io_service &ioService)
        ...
        desired_agentState_(new dmpc::AgentState),
        agentState_for_simulation_(new dmpc::AgentState),
	...
	dmpc::AgentStatePtr desired_agentState_;
    /*Agent state for simulation of corresponding agent.*/
	dmpc::AgentStatePtr agentState_for_simulation_;
...
typedef std::shared_ptr<CommunicationData> CommunicationDataPtr;

}

#endif // COMMUNICATION_DATA_HPP
