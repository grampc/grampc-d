...
namespace grampcd
{
	...
	public:
		...
		virtual void dfdx_vec(typeRNum* out, ctypeRNum t, ctypeRNum* x, ctypeRNum* u, ctypeRNum *vec, ctypeRNum* p, const typeGRAMPCparam* param) override;
		/*Partial derivate of the dynamics with respect to controls*/
		virtual void dfdu_vec(typeRNum* out, ctypeRNum t, ctypeRNum* x, ctypeRNum* u, ctypeRNum *vec, ctypeRNum* p, const typeGRAMPCparam* param) override;
