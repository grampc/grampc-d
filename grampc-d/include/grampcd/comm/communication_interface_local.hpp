...
namespace grampcd
{
	...
	*/
	...
	public:
		...
		void fromCommunication_send_agentModel(const CommunicationDataPtr& comm_data, const grampcd::AgentModelPtr& model) const;
		...
		void fromCommunication_send_agentState_for_simulation(const CommunicationDataPtr& comm_data, const grampcd::AgentStatePtr& state) const;
