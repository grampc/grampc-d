...
class VDPNonlinearCouplingModel : public grampcd::CouplingModel
{
public:
	VDPNonlinearCouplingModel
	(
...
CEREAL_REGISTER_TYPE(VDPNonlinearCouplingModel);
CEREAL_REGISTER_POLYMORPHIC_RELATION(grampcd::CouplingModel, VDPNonlinearCouplingModel)