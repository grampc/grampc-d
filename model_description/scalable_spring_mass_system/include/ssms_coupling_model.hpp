...
#ifndef SSMS_couplingModel_HPP
#define SSMS_couplingModel_HPP

#include "dmpc/model/coupling_model.hpp"

class SSMSCouplingModel : public dmpc::CouplingModel
{
public:
	SSMSCouplingModel(const std::vector<typeRNum>& model_parameters, const std::string& name);
