...
class SSMSCouplingModel : public grampcd::CouplingModel
{
public:
	SSMSCouplingModel
	(
...
CEREAL_REGISTER_TYPE(SSMSCouplingModel);
CEREAL_REGISTER_POLYMORPHIC_RELATION(grampcd::CouplingModel, SSMSCouplingModel)