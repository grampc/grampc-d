...
class SSMSAgentModel : public grampcd::AgentModel
{
public:
	SSMSAgentModel(
...
CEREAL_REGISTER_TYPE(SSMSAgentModel);
CEREAL_REGISTER_POLYMORPHIC_RELATION(grampcd::AgentModel, SSMSAgentModel)