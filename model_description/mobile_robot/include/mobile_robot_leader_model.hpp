...
class MobileRobotLeaderModel : public grampcd::AgentModel
{
public:
	MobileRobotLeaderModel(
...
CEREAL_REGISTER_TYPE(MobileRobotLeaderModel);
CEREAL_REGISTER_POLYMORPHIC_RELATION(grampcd::AgentModel, MobileRobotLeaderModel)