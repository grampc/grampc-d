...
class MobileRobotFollowerModel : public grampcd::AgentModel
{
public:
	MobileRobotFollowerModel(
...
CEREAL_REGISTER_TYPE(MobileRobotFollowerModel);
CEREAL_REGISTER_POLYMORPHIC_RELATION(grampcd::AgentModel, MobileRobotFollowerModel)