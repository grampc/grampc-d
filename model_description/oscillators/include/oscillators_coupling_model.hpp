...
#ifndef OSCILLATORS_couplingModel_HPP
#define OSCILLATORS_couplingModel_HPP
...
{
public:
	OscillatorsCouplingModel(const std::vector<typeRNum>& model_parameters, const std::string& name);
...
#endif // OSCILLATORS_couplingModel_HPP
