...
class SSMS2DCouplingModel : public grampcd::CouplingModel
{
public:
	SSMS2DCouplingModel
	(
...
CEREAL_REGISTER_TYPE(SSMS2DCouplingModel);
CEREAL_REGISTER_POLYMORPHIC_RELATION(grampcd::CouplingModel, SSMS2DCouplingModel)